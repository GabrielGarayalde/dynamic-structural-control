...
if __name__ == "__main__":
    ...
    env = BoxMass1DEnv(render_mode="human")
    ...
    import os
    save_dir = 'saved_models_500eps_800_freq0.5A'
    ...
    torch.save(agent.policy_net.state_dict(), os.path.join(save_dir, "dqn_1000eps_final.pth"))
