...
class BayesianNoiseEstimator:
    def __init__(self, det_sindy_model, rows_for_coeffs=(1,3), n_walkers=16):
        """
        MCMC to estimate sigma_epsilon_1, sigma_epsilon_2 for v1_dot, v2_dot
        in a 2DOF system with alpha(t) + known sinusoidal forcing as inputs.
        """
    ...
    def log_likelihood(self, theta, X, X_dot, U_2d, t):
        ...
        dt = t[1] - t[0]
        # Residual for v1_dot, v2_dot
        X_dot_pred = self.det_sindy_model.predict(X, u=U_2d)  # shape (N,4)
    ...
    def fit(self, X, X_dot, alpha_array, sin_forcing_array, t,
            n_steps=2000, initial_sigma=(0.1, 0.1)):
        """
        Perform MCMC. U_2d = [alpha, sin_forcing].
        """
