...
# def simulate_true(
#     m1, m2, c1, c2, k1, k2,
#     alpha1, alpha2,  # coefficients for x^3 on each mass
#     theta_0_1, theta_0_2,
#     x0, t, U,
#     noise_array_1, noise_array_2
# ):
#     """
#     Simulate a 2DOF system with Duffing-type nonlinearities (x^3).
    
#     States: X = [x1, v1, x2, v2]

#     v1_dot = [1/m1]*(theta_0_1 
#                       - c1*v1 
#                       - k1*x1
#                       - c2*(v1 - v2) 
#                       - k2*(x1 - x2)
...
#     # Compute derivatives array (just like the linear version)
#     X_dot_true = np.zeros_like(X_true)
#     for i in range(len(t)-1):
