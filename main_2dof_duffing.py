...
# Local imports
from simulate_2dof_duffing import simulate_true, compute_true_coeffs
...
if __name__ == "__main__":
    ...
    alpha1, alpha2 = 5.0, 5.0   # cubic stiffness values (example)
    ...
    X_true, X_dot_true = simulate_true(
        m1, m2, c1, c2, k1, k2, alpha1, alpha2,
        theta_0_1, theta_0_2,
        x0, t, U,
    ...
    # E2) Accuracy Metrics for SINDy Estimate
    # ---------------------------------------
    mean_abs_diff = df_pruned['Abs. Diff'].mean()
    rms_diff = np.sqrt(np.mean(df_pruned['Abs. Diff']**2))

    print("\n*** SINDy Parameter Accuracy ***")
